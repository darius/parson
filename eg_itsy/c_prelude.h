...
// Definitions from Ion by Per Vognsen. I need these for the Bitwise
// homework for now. In the longer term we'll presumably want a more
// flexible way to bring in external headers/libraries.
